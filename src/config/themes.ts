...
const defaultTheme: Theme = {
  ...
  mode: 'light',
  global: {
    canvasBackgroundColor: 'rgba(255, 255, 255, 0.95)',
    canvasBackdropFilter: 'blur(10px)',
    canvasBorderColor: 'rgba(0, 0, 0, 0.05)',
    canvasOpacity: 0.95,
    textColor: '#1e1e1e',
    accentColor: '#0078d4',
    glassBlur: '10px',
    titleBarBgColor: 'rgba(255, 255, 255, 0.95)',
    titleBarOpacity: 0.95,
    titleBarTextColor: '#1e1e1e'
  },
  components: {
    button: { backgroundColor: 'rgba(0, 120, 212, 0.3)', color: '#ffffff', borderColor: 'rgba(0, 0, 0, 0.1)' },
    input: { backgroundColor: 'rgba(255, 255, 255, 0.2)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.3)', padding: 4 },
    label: { color: '#1E1F22', fontWeight: 'normal', textAlign: 'left' },
    checkbox: { color: '#333333' },
    toggle: { trackColor: 'rgba(200, 200, 200, 0.5)', knobColor: '#ffffff', activeTrackColor: 'rgba(0, 120, 212, 0.7)', backgroundColor: 'rgba(200, 200, 200, 0.5)' },
    comboBox: { backgroundColor: 'rgba(255, 255, 255, 0.2)', color: '#1E1F22', borderColor: 'rgba(128, 128, 128, 0.3)', padding: 4 },
    hyperLink: { color: '#0078d4', textDecoration: 'underline' },
    radioGroup: { color: '#333333' },
    tabsContainer: { backgroundColor: 'rgba(255, 255, 255, 0.15)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.2)', tabHeaderBg: 'rgba(255, 255, 255, 0.1)', tabBtnBg: 'rgba(255, 255, 255, 0.1)', tabActiveBg: 'rgba(255, 255, 255, 0.3)', tabActiveBorderColor: '#0078d4', tabInactiveBg: 'rgba(255, 255, 255, 0.1)' },
    progressBar: { backgroundColor: 'rgba(224, 224, 224, 0.3)', barColor: 'rgba(0, 120, 212, 0.8)', color: '#ffffff', valueColor: '#ffffff' },
    listBox: { backgroundColor: 'rgba(255, 255, 255, 0.15)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.2)', itemHoverBg: 'rgba(0, 120, 212, 0.15)', itemSelectedBg: 'rgba(0, 120, 212, 0.5)', itemSelectedColor: '#ffffff', itemColor: '#333333' },
    treeView: { backgroundColor: 'rgba(255, 255, 255, 0.15)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.2)', itemHoverBg: 'rgba(0, 120, 212, 0.15)', itemSelectedBg: 'rgba(0, 120, 212, 0.5)', itemSelectedColor: '#ffffff', treeSelectedBg: 'rgba(0, 120, 212, 0.2)', treeToggleColor: 'rgba(102, 102, 102, 0.7)' },
    dataGrid: { backgroundColor: 'rgba(255, 255, 255, 0.15)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.2)', headerBg: 'rgba(255, 255, 255, 0.2)', rowHoverBg: 'rgba(0, 120, 212, 0.08)', rowSelectedBg: 'rgba(0, 120, 212, 0.15)', gridHeaderBg: 'rgba(240, 240, 240, 0.3)', gridEvenRowBg: 'rgba(250, 250, 250, 0.2)', gridHoverBg: 'rgba(230, 247, 255, 0.3)', gridFocusedBg: 'rgba(214, 228, 255, 0.3)' },
    cardBox: { backgroundColor: 'rgba(255, 255, 255, 0.25)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.2)', headerColor: 'rgba(245, 245, 245, 0.5)', headerTitleColor: '#1E1F22', collapseBtnColor: 'rgba(102, 102, 102, 0.7)' },
    contextMenu: { backgroundColor: 'rgba(255, 238, 233, 0.9)', color: '#1E1F22' },
    tooltip: { backgroundColor: 'rgba(233, 249, 255, 0.9)', color: '#333', borderColor: 'rgba(128, 128, 128, 0.2)' },
    textarea: { backgroundColor: 'rgba(255, 255, 255, 0.2)', color: '#333333', borderColor: 'rgba(128, 128, 128, 0.3)', padding: 4, fontSize: 13 },
    iconButton: { backgroundColor: 'rgba(0, 120, 212, 0.8)', color: '#ffffff' },
    imageBox: { backgroundColor: 'rgba(240, 240, 240, 0.3)', borderColor: 'rgba(128, 128, 128, 0.2)' },
    divider: { borderColor: 'rgba(208, 208, 208, 0.4)', lineStyle: 'solid', backgroundColor: 'rgba(255, 255, 255, 0.1)' },
